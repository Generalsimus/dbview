...
export const getBasicModelDoc = (): MakeCreateOrUpdate<SaveModelArgs> => {
  const objectSchema: SaveModelArgs["objectSchema"] = []
  //  satisfies SelectType<
  //   SaveModelArgs["objectSchema"]
  // > &
  //   InsertType<SaveModelArgs["objectSchema"]> &
  //   UpdateType<SaveModelArgs["objectSchema"]>;
  return {
    name: "",
    description: "",
...
export const getRouteIndexedDBStorage = <D extends any>() => {
  ...
  return db.createStorage<MakeCreateOrUpdate<Route>, typeof params>(
