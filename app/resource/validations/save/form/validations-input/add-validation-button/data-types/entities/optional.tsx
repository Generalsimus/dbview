...
import { NumberEntityValidationSchema, NumberMaxLengthEntityType, NumberMinLengthEntityType, NumberOptionalEntityType } from "@/basic/models/validation/data-types/number";
...
interface IProps<Value = NumberOptionalEntityType | StringOptionalEntityType> extends InputProps<Value> {
    onRemove: () => void
}
