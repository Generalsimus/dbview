...
export class IndexedDBController {
    ...
    createStorage<M>(storageName: string, objectStoreParameters: IDBObjectStoreParameters, indexes = {}) {
        return new IndexedDBStorageController<M>(this, storageName, objectStoreParameters);
    }
    get db() {
